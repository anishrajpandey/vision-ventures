    ...
    <div className="h-[500vh] md:h-[145vh] ">
      <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full w-4/5 mx-auto ">
        <div className=" relative group overflow-hidden">
          <Image
            className="max-w-sm object-contain md:object-cover transition-all  duration-300 cursor-pointer filter md:grayscale group-hover:grayscale-0 group-hover:scale-105"
            fill
