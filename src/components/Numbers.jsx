...
const Numbers = () => {
  return (
    <section class="py-10 lg:py-20 bg-stone-100 font-poppins my-12">
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                  <div class="p-6 bg-white ">
                    ...
                    <h2 class="text-sm text-gray-700 ">Helped Businesses</h2>
                  </div>
                </div>
                <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                  <div class="p-6 bg-white ">
                ...
                <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                  <div class="p-6 bg-white ">
                    ...
                    <h2 class="text-sm text-gray-700 ">Delivery Timing</h2>
                  </div>
                </div>
              </div>
            </div>
