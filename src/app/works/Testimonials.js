...
const Testimonials = () => {
  ...
  return (
    <section className="my-8">
      ...
      <div class="flex flex-col items-center flex-wrap justify-center w-full gap-4p-8 mb-8 md:flex-row md:mb-0 flex-between">
        {orders[0] &&
          orders.map(({ Name, Post, Testimonial, ImageURL, id }) => {
            return (
              <Fade key={id}>
                <div class="bg-orange-100 hover:scale-105 pointer w-72 shadow-lg mx-auto my-2 rounded-xl p-4">
                  ...
                  <div class="flex items-center mt-4">
                    ...
                    <div class="flex flex-col justify-between ml-2">
                      <span class="text-md font-semibold text-indigo-800">
                        {Name}{" "}
                      </span>
